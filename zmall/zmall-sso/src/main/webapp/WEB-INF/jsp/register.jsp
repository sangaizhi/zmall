...
<head>
    ...
    <title>注册-个人用户</title>
    <link type="text/css" rel="stylesheet" href="/public/css/regist.personal.css"/>
    <link type="text/css" rel="stylesheet" href="/public/css/passport.base.css"/>
...
<div class="w" id="logo">
    <div>
        <a href="http://www.taotao.com">
            <img src="/public/images/taotao-logo.gif" alt="淘淘商城" width="170" height="60"/>
        </a> <b></b>
    </div>
</div>
...
<div class="w" id="regist">
    ...
    <div class="mc">
        <form id="personRegForm" method="post" onsubmit="return false;">
                ...
                <div class="item" id="select-regName">
                    ...
                    <div class="fl item-ifo">
                        <div class="o-intelligent-regName">
                            <input type="text" id="regName" name="name" class="text" tabindex="1" autoComplete="off"
            ...
            <div class="phone">
                <img width="180" height="180" src="/public/images/phone-bg.jpg">
            </div>
            <span class="clr"></span>
        </form>
    </div>
