...
<div class="w">
    <div id="logo">
        <a href="http://www.taotao.com" clstag="passport|keycount|login|01">
            <img src="/public/images/taotao-logo.gif" alt="淘淘" width="170" height="60"/>
        </a><b></b>
    </div>
</div>
    ...
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            <div id="entry-bg" clstag="passport|keycount|login|02"
                 style="width: 511px; height: 455px; position: absolute; left: -44px; top: -44px; background: url(/public/images/544a11d3Na5a3d566.png) 0px 0px no-repeat;">
            </div>
            <div class="form ">
